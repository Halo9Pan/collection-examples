...
import info.halo9pan.examples.prospring3.ch20.web.controller.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Contact, String> ApplicationConversionServiceFactoryBean.getContactToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<info.halo9pan.examples.prospring3.ch20.domain.Contact, java.lang.String>() {
    ...
    public Converter<Long, Contact> ApplicationConversionServiceFactoryBean.getIdToContactConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, info.halo9pan.examples.prospring3.ch20.domain.Contact>() {
            public info.halo9pan.examples.prospring3.ch20.domain.Contact convert(java.lang.Long id) {
    ...
    public Converter<String, Contact> ApplicationConversionServiceFactoryBean.getStringToContactConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, info.halo9pan.examples.prospring3.ch20.domain.Contact>() {
            public info.halo9pan.examples.prospring3.ch20.domain.Contact convert(String id) {
