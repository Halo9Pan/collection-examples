package info.halo9pan.examples.prospring3.ch20.web.controller;
...
public class ContactController {
	...
	public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
		if (page != null || size != null) {
			...
			uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0)
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("contact_birthdate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder
				.getLocale()));
	}
