...
public class MyAdvice {
	...
	@Pointcut("execution(* info.halo9pan.examples.prospring3.ch7..foo*(int)) && args(intValue)")
	...
	public void simpleBeforeAdvice(JoinPoint joinPoint, int intValue) {
		...
		if (intValue != 100) {
			System.out.println("Executing: " + joinPoint.getSignature().getDeclaringTypeName() + " " + joinPoint
					.getSignature().getName() + " argument: " + intValue);
		}
	}
	...
	public Object simpleAroundAdvice(ProceedingJoinPoint pjp, int intValue) throws Throwable {
		...
		System.out.println("Before execution: " + pjp.getSignature().getDeclaringTypeName() + " " + pjp.getSignature()
				.getName() + " argument: " + intValue);

		Object retVal = pjp.proceed();

		System.out.println("After execution: " + pjp.getSignature().getDeclaringTypeName() + " " + pjp.getSignature()
				.getName() + " argument: " + intValue);
