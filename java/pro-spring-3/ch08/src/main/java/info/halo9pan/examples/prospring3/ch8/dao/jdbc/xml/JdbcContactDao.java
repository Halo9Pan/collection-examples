 ...
 */
package info.halo9pan.examples.prospring3.ch8.dao.jdbc.xml;

import info.halo9pan.examples.prospring3.ch8.dao.ContactDao;
import info.halo9pan.examples.prospring3.ch8.domain.Contact;
import info.halo9pan.examples.prospring3.ch8.domain.ContactTelDetail;
...
public class JdbcContactDao implements ContactDao, InitializingBean {
	...
	public String findFirstNameById(Long id) {
		String firstName = jdbcTemplate
				.queryForObject("select first_name from contact where id = ?", new Object[] { id }, String.class);
		return firstName;
	}
