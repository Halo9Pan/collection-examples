 ...
 */
package info.halo9pan.examples.prospring3.ch18.web.controller;
...
import info.halo9pan.examples.prospring3.ch18.web.view.ContactBean;
import info.halo9pan.examples.prospring3.ch18.web.view.ContactListBean;
...
public class ContactController {
	...
	public void saveContact(RequestContext context) {
		...
		context.getMessageContext()
				.addMessage(new MessageBuilder().info().code("message_contact_save_success").build());
