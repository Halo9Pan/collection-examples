 ...
 */
package info.halo9pan.examples.prospring3.ch14.jsr303;

import info.halo9pan.examples.prospring3.ch14.domain.Customer;
import info.halo9pan.examples.prospring3.ch14.domain.CustomerType;
import info.halo9pan.examples.prospring3.ch14.jsr303.service.MyBeanValidationService;
...
public class Jsr303Sample {
	...
	public static void main(String[] args) {
		...
		MyBeanValidationService myBeanValidationService = ctx
				.getBean("myBeanValidationService", MyBeanValidationService.class);
	...
	private static void listViolations(Set<ConstraintViolation<Customer>> violations) {
		...
		for (ConstraintViolation<Customer> violation : violations) {
			System.out
					.println("Validation error for property: " + violation.getPropertyPath() + " with value: " + violation
							.getInvalidValue() + " with error message: " + violation.getMessage());
		}
